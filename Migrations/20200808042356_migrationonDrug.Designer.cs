...
namespace DrugVerizone.Migrations
{
    ...
    [Migration("20200808042356_migrationonDrug")]
    partial class migrationonDrug
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DrugVerizone.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("DrugVerizone.Entities.Complaints", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DrugVerizone.Entities.DrugTypes", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DrugVerizone.Entities.Drugs", b =>
                {
                    b.HasOne("DrugVerizone.Entities.DrugTypes", "DrugType")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DrugVerizone.Entities.ApplicationUser", null)
                        .WithMany()
